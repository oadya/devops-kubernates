...
- si vous utilisez une version de Kubernetes < 1.19, vous pourrez utiliser le contenu suivant qui fait référence à la version beta de la ressource *CertificateSigningRequest*
